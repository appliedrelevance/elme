...
const remove_unused_assets_controller_1 = require("./remove-unused-assets-controller");
                    ...
                    if (folder) {
                        ...
                        switch (selection.label.toLowerCase()) {
                            ...
                            case "unused images and includes":
                                ...
                                remove_unused_assets_controller_1.removeUnusedImagesAndIncludes(workspacePath, progress, promises, resolve);
                                shoudShowFileLevelProgress = false;
