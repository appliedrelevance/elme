...
const video_1 = require("./markdown-extensions/video");
    ...
    return {
        extendMarkdownIt(md) {
            return md.use(includes_1.include, { root: workingPath })
                ...
                .use(codesnippet_1.tripleColonCodeSnippets, { root: workingPath })
                .use(xref_1.xref)
                .use(column_1.column_end)
                .use(container_1.container_plugin, "row", row_1.rowOptions)
                .use(container_1.container_plugin, "row-end", row_1.rowEndOptions)
                .use(container_1.container_plugin, "column", column_1.columnOptions)
                .use(container_1.container_plugin, "column-end", column_1.columnEndOptions)
                ...
                .use(video_1.video_plugin, "video", video_1.videoOptions);
        },
    };
}
