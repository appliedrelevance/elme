    ...
    if (customPropertyData) {
        ...
        if (customPropertyData.globalValue) {
            ...
            if (individualValues.indexOf(docsMarkdownRuleset) > -1) {
                ...
                vscode_1.workspace.getConfiguration().update(customProperty, individualValues, vscode_1.ConfigurationTarget.Global);
                exports.output.appendLine(`[${msTimeValue}] - docs-markdown custom markdownlint ruleset removed from user settings.`);
            }
        }
