...
const toggleStrikethroughPattern = new RegExp(
...
var codeBlockWordPattern = new RegExp(
...
var startingNote = '>[!NOTE]' + newLine + '>' + newLine + '>';
var endingNote = newLine;
var noteBlockWordPattern = new RegExp(
