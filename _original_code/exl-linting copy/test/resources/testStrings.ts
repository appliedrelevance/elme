...
export let NonFormattedSingleLineText: string =
  "This is sample text. Singleline, without formatting.";
export let CodeFormattedSingleLineText: string =
  "`This is sample text in a markdown code block.`";
export let BoldFormattedSingleLineText: string =
  "**This is sample text in markdown bold format.**";
export let ItalicFormattedSingleLineText: string =
  "*This is sample text in markdown italic format.*";
export let NoteFormattedSingleLineText: string =
  '> [!NOTE]\r\n> This is sample text formatted as an alert of type "Note".';
export let ImportantFormattedSingleLineText: string =
  '> [!IMPORTANT]\r\n> This is sample text formatted as an alert of type "Important".';
export let WarningFormattedSingleLineText: string =
  '> [!WARNING]\r\n> This is sample text formatted as an alert of type "Warning".';
export let TipFormattedSingleLineText: string =
  '> [!TIP]\r\n> This is sample text formatted as an alert of type "Tip".';
export let NestedSingleLineCodeFormattedSingleLineText: string =
  "This is sample text with a `Nested Code` block inside it.";
export let CodeFormattedNestedSingleLineCodeFormattedSingleLineText: string =
  "`This is sample text with a `Nested Code` block inside it.`";
export let NestedBoldFormattedSingleLineText: string =
  "This is sample text with a **Nested Bold** block inside it.";
export let BoldFormattedNestedBoldFormattedSingleLineText: string =
  "**This is sample text with a **Nested Bold** block inside it.**";
export let NestedItalicFormattedSingleLineText: string =
  "This is sample text with a *Nested Italic* block inside it.";
export let ItalicFormattedNestedItalicFormattedSingleLineText: string =
  "*This is sample text with a *Nested Italic* block inside it.*";
...
export let NoteFormattedMultilineText: string =
  '> [!NOTE]\r\n> This is sample text formatted as an alert of type "Note".\r\n> This is multiline text.';
export let ImportantFormattedMultilineText: string =
  '> [!IMPORTANT]\r\n> This is sample text formatted as an alert of type "Important".\r\n> This is multiline text.';
export let WarningFormattedMultilineText: string =
  '> [!WARNING]\r\n> This is sample text formatted as an alert of type "Warning".\r\n> This is multiline text.';
export let TipFormattedMultilineText: string =
  '> [!TIP]\r\n> This is sample text formatted as an alert of type "Tip".\r\n> This is multiline text.';
...
export let BoldFormattedNestedBoldFormattedMultiLineText: string =
  "**This is sample text with a **Nested \r\n Bold** block inside it.**";
export let ItalicFormattedNestedItalicFormattedMultiLineText: string =
...
export let sampleExternalLink =
  "This is an external link to bing.com: [Bing](http://www.bing.com)";
export let sampleInternalLink =
  "This is an internal link to a relative path: [A relative path](....README.md)";
export let sampleArtLink =
  "An art link: ![Additionally](../media/link-checker-1.png)";
export let sampleInclude = "[!INCLUDE [README](../../README.md)]";

// Bookmark duplicate string
export let duplicateBookmarkString: string[] = [
  "# Test\r\n",
  "# Test\r\n",
  "## Test\r\n",
];
export let expectBookmarkString: string[] = [
  "# Test\r\n",
  "# Test (1)\r\n",
  "## Test\r\n",
];
