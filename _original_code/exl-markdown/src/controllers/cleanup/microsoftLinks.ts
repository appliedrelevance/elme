...
export function handleLinksWithRegex(data: string) {
  ...
  const docsRegex = new RegExp(/http:\/\/docs.adobe.com/g);
  data = data.replace(docsRegex, "https://docs.adobe.com");
  ...
  const docsRegexLang = new RegExp(/https:\/\/docs.adobe.com\/[A-Za-z]{2}-[A-Za-z]{2}\//g);
  data = data.replace(docsRegexLang, "https://docs.adobe.com/");
